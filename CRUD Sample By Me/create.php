              ...
              <div class="card-body">
                <form class="" action="add.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="sell" placeholder="Enter price" value="">
                    </div>
                    <div class="form-group">
                      <label for="email">Harga Beli</label>
                      <input type="number" class="form-control" name="buy" placeholder="Enter price" value="">
                    </div>
                    <div class="form-group">
                      <label for="email">Stok</label>
                      <input type="number" class="form-control" name="stok" placeholder="Enter Stok" value="">
                    </div>
                    <div class="form-group">
